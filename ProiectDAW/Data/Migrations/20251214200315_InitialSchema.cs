        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Follows_AspNetUsers_EditorId",
                        column: x => x.EditorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TrustScore = table.Column<decimal>(type: "TEXT", nullable: true),
                    TrustLabel = table.Column<string>(type: "TEXT", nullable: true),
                    AiJustification = table.Column<string>(type: "TEXT", nullable: true),
                    EditorId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsArticles_AspNetUsers_EditorId",
                        column: x => x.EditorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
